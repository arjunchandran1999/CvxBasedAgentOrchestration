# Experiment analysis (20260225-224209)
...
## Deep dive: multi-agent usage (from telemetry)

- **agentic_bench / llm**: runs=1, mean distinct assigned models/job=3, frac jobs w/ >1 assigned model=1, mean active_models/job=3, mean models_swapped_in/job=3
- **agentic_bench / lp**: runs=1, mean distinct assigned models/job=2, frac jobs w/ >1 assigned model=1, mean active_models/job=2, mean models_swapped_in/job=2
- **code_math_mix / llm**: runs=6, mean distinct assigned models/job=1, frac jobs w/ >1 assigned model=0, mean active_models/job=1, mean models_swapped_in/job=0.375
- **code_math_mix / lp**: runs=6, mean distinct assigned models/job=1, frac jobs w/ >1 assigned model=0, mean active_models/job=1.083, mean models_swapped_in/job=0.4167
- **workflowbench / llm**: runs=2, mean distinct assigned models/job=2, frac jobs w/ >1 assigned model=0.8333, mean active_models/job=2, mean models_swapped_in/job=0.8333
- **workflowbench / lp**: runs=2, mean distinct assigned models/job=1.333, frac jobs w/ >1 assigned model=0.3333, mean active_models/job=1.333, mean models_swapped_in/job=0.5
